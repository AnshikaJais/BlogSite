...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"postCommentBlog.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.postComment = exports.postBlog = void 0;
...
var postComment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(comment, blog, user) {
    var res;
...
var postBlog = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(name, email, title, subTitle, description, user) {
    var res;
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              alert("Blog posted!");
              window.setTimeout(function () {
                location.assign("/blog/".concat(title));
              }, 1500);
            }
            _context2.next = 10;
            break;
  ...
  return function postBlog(_x4, _x5, _x6, _x7, _x8, _x9) {
    return _ref2.apply(this, arguments);
  };
}();
exports.postBlog = postBlog;
},{"axios":"../../node_modules/axios/index.js"}],"loginSignup.js":[function(require,module,exports) {
"use strict";
...
var _postCommentBlog = require("./postCommentBlog");
var _loginSignup = require("./loginSignup");
//VALUES
var loginForm = document.querySelector(".login-form");
var logoutBtn = document.getElementById("logout-btn");
var warning = document.querySelector(".overview-container .warning");
var commentForm = document.querySelector(".comment-form");
var signupForm = document.querySelector(".signup-form");
var postBlogForm = document.querySelector(".post-blog-form");
if (loginForm) {
...
if (logoutBtn) {
  logoutBtn.addEventListener("click", _loginSignup.logout);
}
if (commentForm) {
  commentForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var comment = document.getElementById("comment").value;
    var blog = document.querySelector("input[name=blog]").value;
    var user = document.querySelector("input[name=user]").value;
    console.log(comment, blog, user);
    (0, _postCommentBlog.postComment)(comment, blog, user);
  });
}
if (warning) {
...
if (postBlogForm) {
  postBlogForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var name = document.querySelector("input[name=blog-user-name]").value;
    var email = document.querySelector("input[name=blog-user-email]").value;
    ...
    var user = document.querySelector("input[name=blog-user-id]").value;
    (0, _postCommentBlog.postBlog)(name, email, title, subTitle, description, user);
  });
}
},{"./postCommentBlog":"postCommentBlog.js","./loginSignup":"loginSignup.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
